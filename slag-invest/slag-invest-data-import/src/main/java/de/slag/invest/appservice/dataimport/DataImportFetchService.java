...
import de.slag.invest.appservice.av.AvProperties;
import de.slag.invest.appservice.av.stock.AvStock;
import de.slag.invest.appservice.av.stock.AvStockCall;
import de.slag.invest.appservice.av.stock.AvStockCallBuilder;
import de.slag.invest.appservice.av.stock.AvStockResponse;
import de.slag.invest.dtomodel.StockValueDto;

@Service
public class DataImportFetchService {
	...
	List<StockValueDto> fetchData() {
		String fetchFile = getAdmValue(DataImportProperties.FETCH_FILE);
		...
		final List<StockValueDto> allStockValueDtos = responses.stream().map(resp -> {
	...
	private StockValueDto stockValueDtoOf(AvStock stock, String isin) {
		final StockValueDto stockValueDto = new StockValueDto();
